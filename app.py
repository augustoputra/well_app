...
AVE_GROSS = st.number_input("Average Fluid Gross (bopd)", 0.0, 5000.0, 1500.0, step=10.0)
AVE_GAS = st.number_input("Average GAS (Mscfd)", 0.0, 500.0, 10.0, step=1.0)
...
SL = st.number_input("Stroke Length (inch)", 0.0, 500.0, 50.0, step=1.0)
SPM = st.number_input("Stroke Per Minute", 0.0, 60.0, 5.0, step=0.1)
SM = st.number_input("Submergence (SM, in meter)", 0.0, 100.0, 100.0, step=1.0)
...
FREQ_OFF = st.number_input("Freq Off", 0.0, 500.0, 1.0, step=1.0)
HOUR_OFF = st.number_input("Hour Off", 0.0, 500.0, 1.0, step=1.0)
