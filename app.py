...
# ================================
PSN = st.number_input("PSN", min_value=0.0, max_value=2500.0, value=1500.0)
AVE_GROSS = st.number_input("Average Fluid Gross (bopd)", min_value=0.0, max_value=2500.0, value=1500.0)
AVE_GAS = st.number_input("Average GAS (Mscfd)", min_value=0.0, max_value=1000.0, value=10.0)
PUMP_EFF = st.number_input("Pump Efficiency", min_value=0.0, max_value=1.0, value=0.5)
OD_PUMP = st.number_input("Pump Outer Diameter (inch)", min_value=1.0, max_value=5.0, value=2.5)
SL = st.number_input("Stroke Length (inch)", min_value=0.0, max_value=200.0, value=50.0)
SPM = st.number_input("Stroke Per Minute", min_value=0.0, max_value=13.0, value=5.0)
SM = st.number_input("Submergence (SM, in meter)", min_value=0.0, max_value=3000.0, value=100.0)
TORQUE = st.number_input("Torque", min_value=0.0, max_value=1.0, value=0.5)
LOAD = st.number_input("Load", min_value=0.0, max_value=1.0, value=0.5)
ROD_STRESS = st.number_input("Rod Stress", min_value=0.0, max_value=1.0, value=0.5)
FREQ_OFF = st.number_input("Freq Off", min_value=0.0, max_value=500.0, value=10.0)
HOUR_OFF = st.number_input("Hour Off", min_value=0.0, max_value=9000.0, value=20.0)
